...
### Added
- Email signatures, thread list date grouping and sender avatars
...
### Fixed
- SES webhook logging, SNS subscription handling, Mailgun empty GET payload fix
## [0.2.22] - 2026-03-11
...
### Added
- Complete code review Phase 5 — test coverage and bug fix
## [0.2.11] - 2026-03-04
