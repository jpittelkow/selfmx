...
export default function SpamFilterPage() {
  ...
  const handleAdd = async () => {
    ...
    if (!trimmed) return;
    if (newMatchType === "exact" && (!trimmed.includes("@") || !trimmed.includes("."))) {
      toast.error("Please enter a valid email address");
      return;
    }
    if (newMatchType === "domain" && (trimmed.includes("@") || !trimmed.includes("."))) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Manage your personal allow and block lists to control which senders can reach your inbox.
        </p>
      </div>
